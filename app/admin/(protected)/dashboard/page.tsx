...
Welcome back! Here&apos;s a quick overview of your content and activity.
</p>
</motion.div>
...
Manage your portfolio content efficiently. Use the navigation to add,
edit, or delete projects, blogs, and respond to contact messages. All
...
<p className='text-2xl font-bold text-accent'>{stats.unread}</p>
</div>
